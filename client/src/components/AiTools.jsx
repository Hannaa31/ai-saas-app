  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
      <div className='text-center'>
        <h2 className='text-slate-700 text-[42px] font-semibold'>Smart AI Features</h2>
        <p className='text-gray-500 max-w-lg mx-auto'>Access everything you need to build, improve, and refine your content using advanced AI technology.</p>
      </div>
